...
export const getContactsFormConfig = (): FormConfig => ({
  ...
  fields: [
    ...
    },
    {
      ...
      validationPreset: 'phoneInternational',
      gridCols: 1,
    },
    {
      name: 'structureWhatsapp',
      label: 'WhatsApp de la structure',
      type: 'tel',
      placeholder: '+224 622 000 000',
      validationPreset: 'phoneInternational',
      gridCols: 1,
    ...
    },
    {
      ...
      label: 'Site web',
      type: 'url',
      placeholder: 'https://cep.gn',
      validationPreset: 'url',
      gridCols: 1,
    },
    {
      name: 'address',
  ...
  fields: [
    {
      ...
      validationPreset: 'url',
      helperText: 'Lien vers le système parent si applicable',
      colSpan: 'full',
    },
  ],
})
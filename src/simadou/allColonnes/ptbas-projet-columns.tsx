...
import { PtbaProjet } from '../allTypes'
...
type PtbasRowActionsProps = {
    ...
    setCurrentRow: React.Dispatch<React.SetStateAction<PtbaProjet | null>>
}
...
export const buildPtbasProjetColumns = (
    setOpen: (dialog: PtbasDialogType | null) => void,
    setCurrentRow: React.Dispatch<React.SetStateAction<PtbaProjet | null>>,
    onOpenPlanification: (activite: PtbaProjet) => void,
    currencyCode?:string
) => {
    const baseColumns = buildColumns<PtbaProjet>([
    ...
    const actionsColumn: ColumnDef<PtbaProjet> = {
        id: "actions",
        accessorKey: 'id_ptba',
        header: ({ column }) => (
    ...
    const chronogrammeColumns: ColumnDef<PtbaProjet>[] = getMoisOptions().map((mois, index) => ({
    ...
    const planificationColumn: ColumnDef<PtbaProjet> = {
        id: 'planification',
        header: ({ column }) => (
            <DataTableColumnHeader
                column={column}

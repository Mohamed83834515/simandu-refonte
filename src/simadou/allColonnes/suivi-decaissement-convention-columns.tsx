...
export function buildSuiviDecaissementConventionColumns({
  onEdit,
  onDeleteRequest,
}: {
  onEdit: (row: SuiviDecaissementConvention) => void
  onDeleteRequest: (row: SuiviDecaissementConvention) => void
}): ColumnDef<SuiviDecaissementConvention>[] {
  return [
    {
      id: 'date_suivi_dec',
...
export function sumSuiviDecaissementConventionMontant(
  rows: SuiviDecaissementConvention[]
): number {
  return rows.reduce(

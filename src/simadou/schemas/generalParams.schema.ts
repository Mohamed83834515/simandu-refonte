...
export const GeneralParamsAPISchema = z.object({
  ...
  ecart_projet_critique:                z.number().int().min(0),
  ecart_projet_retard:                z.number().int().min(0),
...
export const GeneralParamsSchema = GeneralParamsAPISchema.transform(d => ({
  ...
  ecartProjetRetard:          d.ecart_projet_critique,
  ecartProjetCritique:          d.ecart_projet_critique,

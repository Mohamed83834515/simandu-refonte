...
export function buildSuiviAvancementConventionDefaultValues(
  suivi: SuiviAvancementConvention | undefined,
  documentUrls: string[] = []
): SuiviAvancementConventionFormData {
  return {
...
export function pickNewDocumentFiles(
  items: SuiviAvancementConventionFormData['documents_fichiers']
): File[] {
